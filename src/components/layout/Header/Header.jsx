...
const Header = (props) => {
    ...
    const { theme, setTheme, sidebar } = props;

    return ( 
        <>
            <header className={styles.header}>
                <div className={ cx(styles.headerNavbar, sidebar ? styles.hasSidebar : '')}>
                    <Container size="md">
                        <div className={styles.navbarTitle}>
                            <NavLink to="/" className={styles.title}>
                                <img className={styles.logo} src={Icon} alt="Dev Cheats" title="Dev Cheats" /> Dev Cheats
                            </NavLink>
                        </div>
                                ...
                                <nav className={styles.nav}>
                                    {
                                        tools.map((tool, i) => tool.menu &&
                                            <NavLink to={tool.category + "/" + tool.slug} key={i} className={styles.link}>
                                                {tool.title}
                                            </NavLink>
                                        )
                                    }
